...
- Язык: **C++17**
- Работа с JSON: библиотека [nlohmann/json](https://github.com/nlohmann/json) (header-only)
- Сборка: CMake (опционально) или прямой вызов компилятора
...
- Чёткое разделение ответственности классов.
- Лёгкость расширения (новые команды, предметы, враги).
- Возможность сохранения/загрузки в человекочитаемом формате.

Данный документ служит основой для реализации третьего майлстоуна — написания кода игры.
